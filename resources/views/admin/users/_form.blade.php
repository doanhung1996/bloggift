            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="d-flex justify-content-center align-items-center action" id="action-form">
                        <a href="{{ route('admin.users.index') }}" class="btn btn-light"><i class="icon-close2 mr-2"></i>{{ __('Trở lại') }}</a>
                        <div class="btn-group ml-3">
                            ...
                            <div class="dropdown-menu dropdown-menu-right">
                                <a href="javascript:void(0)" class="dropdown-item submit-type" data-redirect="{{ route('admin.users.index') }}">{{ __('Lưu và thoát') }}</a>
                                <a href="javascript:void(0)" class="dropdown-item submit-type" data-redirect="{{ route('admin.users.create') }}">{{ __('Lưu và thêm mới') }}</a>
                            </div>
                        </div>
                    </div>
                </div>
