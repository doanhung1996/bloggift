...
@section('title', __('Tạo quyền'))
@section('page-header')
    <x-page-header>
        <x-slot name='title'>
            <h4><i class="icon-plus-circle2 mr-2"></i> <span class="font-weight-semibold">{{ __('Tạo quyền') }}</span></h4>
        </x-slot>
        {{ Breadcrumbs::render() }}
    </x-page-header>
@stop
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="d-flex justify-content-center align-items-center action" id="action-form">
                        <a href="{{ route('admin.roles.index') }}" class="btn btn-light"><i class="icon-close2 mr-2"></i>{{ __('Trở lại') }}</a>
